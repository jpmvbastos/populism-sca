...
---------------------
   RMSPE |   2.96827 // Worse than baseline 
---------------------
---------------------------------------------------------------------------------------------
Unit Weights:
...
---------------+------------
     ...
     Australia |           0
       ...
       Belgium |           0
        ...
        Canada |           0
         Chile |           0
      Colombia |           0. // Interestingly, largest donor of baseline goes to 0
    Costa Rica |           0
       Denmark |           0
        France |           0
       Germany |           0
...
------------------------------------------------------
                               |   Treated  Synthetic 
-------------------------------+----------------------
                   VDEMy(1996) |      45.8    38.3035 
                   VDEMy(1997) |      41.3    38.7412 
                   VDEMy(1998) |      41.3    39.0266 
                   VDEMy(1999) |      38.6    39.3974 
                   VDEMy(2000) |      38.1    39.3187 
                   VDEMy(2001) |      37.7    39.3994 
                   VDEMy(2002) |      38.2    39.3808 
                   VDEMy(2003) |      37.8    38.7106 
                   VDEMy(2004) |      37.8    39.1335 
                   VDEMy(2005) |      37.8    39.2597 
                   VDEMy(2006) |      33.1    37.3264 
------------------------------------------------------
...
Post-treatment results: Effects, p-values, standardized p-values
             ...
             | estimates      pvals  pvals_std 
-------------+--------------------------------
          c1 |   -15.034   .0740741   .1111111 
          c2 |  -18.2712    .037037   .1851852 
          c3 |  -19.1166    .037037   .1851852 
          c4 |  -19.6062    .037037   .2962963 
          c5 |  -20.5368    .037037   .2962963 
          c6 |  -23.6119    .037037   .2222222 
          c7 |  -25.4539    .037037   .2592593 
          c8 |  -23.3899   .1111111   .2222222 
          c9 |   -22.929   .1481481   .3333333 
         c10 |   -23.102   .1481481   .4444444 


Joint std. p-value (entire post-treatment) 0.296296 // Not significant 
